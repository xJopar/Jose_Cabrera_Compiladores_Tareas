...
{
    // Control de archivos para ver si se pasa el archivo fuente como parametro
    if (argc > 1) 
    {
        ...
        if(bandError == 0)
        {
            printf("En el fuente no existe un error sintactico.\n");
        } else
        {
            printf("En el fuente existe un error sintactico.\n");
        }
        
    } else 
    {
        printf("Verifique la direccion pasada.\n");
        exit(1);
    }
